...
public final class Status {
    ...
    private static final boolean FAIL_ON_EQUALS_FOR_TEST = Boolean.parseBoolean(System.getProperty(TEST_EQUALS_FAILURE_PROPERTY, Bugly.SDK_IS_DEV));
    ...
    public Status augmentDescription(String str) {
        ...
        Code code = this.code;
        return new Status(code, this.description + StringUtils.LF + str, this.cause);
    }
    ...
    private static final class StatusMessageMarshaller implements Metadata.TrustedAsciiMarshaller<String> {
        private static final byte[] HEX = {48, Framer.STDOUT_FRAME_PREFIX, Framer.STDERR_FRAME_PREFIX, 51, 52, 53, 54, 55, 56, 57, Parameter.CommonConstant.ADD_PRE_FIX_BYTE, 66, 67, 68, 69, 70};
