...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private boolean verifyHostName(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(ThreadPoolManager.DOT) && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(ThreadPoolManager.DOT) && !str2.endsWith("..")) {
            if (!str.endsWith(ThreadPoolManager.DOT)) {
                str = str + ClassUtils.PACKAGE_SEPARATOR_CHAR;
            }
            if (!str2.endsWith(ThreadPoolManager.DOT)) {
