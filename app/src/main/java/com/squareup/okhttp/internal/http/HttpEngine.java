...
public final class HttpEngine {
    ...
    private HttpStream connect() throws RouteException, RequestException, IOException {
        return this.streamAllocation.newStream(this.client.getConnectTimeout(), this.client.getReadTimeout(), this.client.getWriteTimeout(), this.client.getRetryOnConnectionFailure(), !this.networkRequest.method().equals(FirebasePerformance.HttpMethod.GET));
    }
    ...
    public class NetworkInterceptorChain implements Interceptor.Chain {
        ...
        public Response proceed(Request request) throws IOException {
            this.calls++;
            if (this.index > 0) {
                Interceptor interceptor = client.networkInterceptors().get(this.index - 1);
            ...
            if (this.index >= client.networkInterceptors().size()) {
                ...
                Response readNetworkResponse = readNetworkResponse();
            ...
            Interceptor interceptor2 = client.networkInterceptors().get(this.index);
    ...
    public Request followUpRequest() throws IOException {
        ...
        } else if (!method.equals(FirebasePerformance.HttpMethod.GET) && !method.equals(FirebasePerformance.HttpMethod.HEAD)) {
            return null;
        }
