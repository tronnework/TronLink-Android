...
public final class RxBleClientImpl_Factory implements Factory<RxBleClientImpl> {
    ...
    public RxBleClientImpl_Factory(Provider<RxBleAdapterWrapper> provider, Provider<ClientOperationQueue> provider2, Provider<Observable<RxBleAdapterStateObservable.BleAdapterState>> provider3, Provider<ScanRecordParser> provider4, Provider<LocationServicesStatus> provider5, Provider<ClientStateObservable> provider6, Provider<RxBleDeviceProvider> provider7, Provider<ScanSetupBuilder> provider8, Provider<ScanPreconditionsVerifier> provider9, Provider<Function<RxBleInternalScanResult, ScanResult>> provider10, Provider<Scheduler> provider11, Provider<ClientComponent.ClientComponentFinalizer> provider12, Provider<BackgroundScanner> provider13, Provider<CheckerLocationPermission> provider14) {
        ...
        this.checkerLocationPermissionProvider = provider14;
    }
    ...
    public static RxBleClientImpl_Factory create(Provider<RxBleAdapterWrapper> provider, Provider<ClientOperationQueue> provider2, Provider<Observable<RxBleAdapterStateObservable.BleAdapterState>> provider3, Provider<ScanRecordParser> provider4, Provider<LocationServicesStatus> provider5, Provider<ClientStateObservable> provider6, Provider<RxBleDeviceProvider> provider7, Provider<ScanSetupBuilder> provider8, Provider<ScanPreconditionsVerifier> provider9, Provider<Function<RxBleInternalScanResult, ScanResult>> provider10, Provider<Scheduler> provider11, Provider<ClientComponent.ClientComponentFinalizer> provider12, Provider<BackgroundScanner> provider13, Provider<CheckerLocationPermission> provider14) {
        return new RxBleClientImpl_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14);
    }
    ...
    public static RxBleClientImpl newRxBleClientImpl(RxBleAdapterWrapper rxBleAdapterWrapper, ClientOperationQueue clientOperationQueue, Observable<RxBleAdapterStateObservable.BleAdapterState> observable, ScanRecordParser scanRecordParser, LocationServicesStatus locationServicesStatus, Lazy<ClientStateObservable> lazy, RxBleDeviceProvider rxBleDeviceProvider, ScanSetupBuilder scanSetupBuilder, ScanPreconditionsVerifier scanPreconditionsVerifier, Function<RxBleInternalScanResult, ScanResult> function, Scheduler scheduler, ClientComponent.ClientComponentFinalizer clientComponentFinalizer, BackgroundScanner backgroundScanner, CheckerLocationPermission checkerLocationPermission) {
        return new RxBleClientImpl(rxBleAdapterWrapper, clientOperationQueue, observable, scanRecordParser, locationServicesStatus, lazy, rxBleDeviceProvider, scanSetupBuilder, scanPreconditionsVerifier, function, scheduler, clientComponentFinalizer, backgroundScanner, checkerLocationPermission);
    }
}
