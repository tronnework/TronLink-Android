...
public class PtrClassicDefaultFooter extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attributeSet) {
        ...
        buildAnimation();
        View inflate = LayoutInflater.from(getContext()).inflate(com.tronlinkpro.wallet.R.layout.cube_ptr_classic_default_footer, this);
        ...
        this.mProgressBar = inflate.findViewById(com.tronlinkpro.wallet.R.id.ptr_classic_header_rotate_view_progressbar);
        resetView();
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout ptrFrameLayout) {
        ...
        if (ptrFrameLayout.isPullToRefresh()) {
            this.mTitleTextView.setText(getResources().getString(com.tronlinkpro.wallet.R.string.cube_ptr_pull_up_to_load));
        } else {
            this.mTitleTextView.setText(getResources().getString(com.tronlinkpro.wallet.R.string.cube_ptr_pull_up));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout ptrFrameLayout) {
        ...
        this.mTitleTextView.setVisibility(View.VISIBLE);
        this.mTitleTextView.setText(com.tronlinkpro.wallet.R.string.cube_ptr_loading);
        tryUpdateLastUpdateTime();
    ...
    public void onUIRefreshComplete(PtrFrameLayout ptrFrameLayout, boolean z) {
        ...
        this.mProgressBar.setVisibility(View.INVISIBLE);
        this.mTitleTextView.setVisibility(View.VISIBLE);
        this.mTitleTextView.setText(getResources().getString(com.tronlinkpro.wallet.R.string.cube_ptr_load_complete));
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout ptrFrameLayout) {
        ...
        this.mTitleTextView.setVisibility(View.VISIBLE);
        this.mTitleTextView.setText(com.tronlinkpro.wallet.R.string.cube_ptr_release_to_load);
    }
