...
public class XTabLayoutV2 extends HorizontalScrollView {
    ...
    public static final String TAG = "XTabLayoutV2";
    ...
    private boolean isSetTabCount;
    private boolean isTabEmptyEqual;
    ...
    private boolean xTabTabRightMargin;
    ...
    public void setSetTabCount(boolean z) {
        this.isSetTabCount = z;
    }

    public void setTabEmptyEqual(boolean z) {
        this.isTabEmptyEqual = z;
    }

    public void setTabEmptyEqual(boolean z, boolean z2) {
        this.isTabEmptyEqual = z;
        this.isWidthFullScreen = z2;
    }
    ...
    public void setxTabSelectedTextBackground(Drawable drawable) {
        this.xTabSelectedTextBackground = drawable;
    }

    public XTabLayoutV2(Context context) {
        this(context, null);
    }

    public XTabLayoutV2(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public XTabLayoutV2(Context context, AttributeSet attributeSet, int i) {
        ...
        this.xTabTabRightMargin = obtainStyledAttributes.getBoolean(25, false);
    ...
    public void setupWithViewPager(ViewPager2 viewPager2) {
        ...
        if (viewPager22 != null && (tabLayoutOnPageChangeListener = this.mPageChangeListener) != null) {
            viewPager22.registerOnPageChangeCallback(tabLayoutOnPageChangeListener);
        }
        if (viewPager2 != null) {
            BaseFragmentAdapter baseFragmentAdapter = (BaseFragmentAdapter) viewPager2.getAdapter();
            ...
            setOnTabSelectedListener(new ViewPagerOnTabSelectedListener(viewPager2));
            setPagerAdapter(baseFragmentAdapter, true);
            if (this.isTabEmptyEqual) {
                int i = 0;
                for (int i2 = 0; i2 < this.mTabStrip.getChildCount(); i2++) {
                    TabView tabView = (TabView) this.mTabStrip.getChildAt(i2);
                    i += (int) tabView.getmTextView().getPaint().measureText(tabView.getText());
                }
                int screenWidth = ((((UIUtils.getScreenWidth(getContext()) - (this.isWidthFullScreen ? 0 : UIUtils.dip2px(120.0f))) - UIUtils.dip2px(40.0f)) - UIUtils.dip2px(30.0f)) - i) / this.mTabStrip.getChildCount();
                for (int i3 = 0; i3 < this.mTabStrip.getChildCount(); i3++) {
                    TabView tabView2 = (TabView) this.mTabStrip.getChildAt(i3);
                    int measureText = ((int) tabView2.getmTextView().getPaint().measureText(tabView2.getText())) + screenWidth + UIUtils.dip2px(12.0f);
                    LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) tabView2.getLayoutParams();
                    if ("Received".equals(tabView2.getText())) {
                        layoutParams.width = measureText + UIUtils.dip2px(4.0f);
                    } else if ("Sent".equals(tabView2.getText())) {
                        layoutParams.width = measureText - UIUtils.dip2px(4.0f);
                    } else {
                        layoutParams.width = measureText - UIUtils.dip2px(6.0f);
                    }
                    LogUtils.d(TAG, "isTabEmptyEqual  " + layoutParams.width);
    ...
    @Deprecated
    public void setTabsFromPagerAdapter(BaseFragmentAdapter baseFragmentAdapter) {
        setPagerAdapter(baseFragmentAdapter, false);
    }
    ...
    private void setPagerAdapter(BaseFragmentAdapter baseFragmentAdapter, boolean z) {
        RecyclerView.AdapterDataObserver adapterDataObserver;
        BaseFragmentAdapter baseFragmentAdapter2 = this.mPagerAdapter;
        if (baseFragmentAdapter2 != null && (adapterDataObserver = this.mPagerAdapterObserver) != null) {
            baseFragmentAdapter2.unregisterAdapterDataObserver(adapterDataObserver);
        }
        this.mPagerAdapter = baseFragmentAdapter;
        if (z && baseFragmentAdapter != null) {
            if (this.mPagerAdapterObserver == null) {
                this.mPagerAdapterObserver = new PagerAdapterObserver();
            }
            baseFragmentAdapter.registerAdapterDataObserver(this.mPagerAdapterObserver);
        }
    ...
    public void populateFromPagerAdapter() {
        ...
        Tab text;
        removeAllTabs();
        BaseFragmentAdapter baseFragmentAdapter = this.mPagerAdapter;
        if (baseFragmentAdapter != null) {
            int itemCount = baseFragmentAdapter.getItemCount();
            BaseFragmentAdapter baseFragmentAdapter2 = this.mPagerAdapter;
            IXTabPagerAdapter iXTabPagerAdapter = baseFragmentAdapter2 instanceof IXTabPagerAdapter ? (IXTabPagerAdapter) baseFragmentAdapter2 : null;
    ...
    private LinearLayout.LayoutParams createLayoutParamsForTabs() {
        ...
        if (this.xTabTabRightMargin) {
            layoutParams.rightMargin = dpToPx(3);
        }
        updateTabViewLayoutParams(layoutParams);
        if (this.isSetTabCount && this.xTabDisplayNum != 0) {
            layoutParams.width = getTabMinWidth();
        }
        return layoutParams;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 0) {
            BaseFragmentAdapter baseFragmentAdapter = this.mPagerAdapter;
            if (baseFragmentAdapter == null || this.xTabDisplayNum == 0) {
            ...
            } else if (baseFragmentAdapter.getItemCount() == 1 || this.xTabDisplayNum == 1) {
    ...
    private int getTabMinWidth() {
        if (this.mPagerAdapter != null && this.xTabDisplayNum != 0) {
            ...
            if (this.mPagerAdapter.getItemCount() == 1 || this.xTabDisplayNum == 1) {
                return getLayoutWidth(windowManager);
            }
            if (this.mPagerAdapter.getItemCount() < this.xTabDisplayNum) {
                return getLayoutWidth(windowManager) / this.mPagerAdapter.getItemCount();
            }
            return getLayoutWidth(windowManager) / this.xTabDisplayNum;
    ...
    private int getLayoutWidth(WindowManager windowManager) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) getLayoutParams();
        return (((windowManager.getDefaultDisplay().getWidth() - getPaddingLeft()) - getPaddingRight()) - marginLayoutParams.leftMargin) - marginLayoutParams.rightMargin;
    }
    ...
    public static final class Tab {
        ...
        public Tab setText(int i) {
            XTabLayoutV2 xTabLayoutV2 = this.mParent;
            if (xTabLayoutV2 == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
            return setText(xTabLayoutV2.getResources().getText(i));
        }
        ...
        public void select() {
            ...
            xTabLayoutV2.selectTab(this);
        }

        public boolean isSelected() {
            XTabLayoutV2 xTabLayoutV2 = this.mParent;
            if (xTabLayoutV2 != null) {
                return xTabLayoutV2.getSelectedTabPosition() == this.mPosition;
            }
            throw new IllegalArgumentException("Tab not attached to a TabLayout");
        }
        ...
        public Tab setContentDescription(int i) {
            ...
            return setContentDescription(xTabLayoutV2.getResources().getText(i));
        }
    ...
    public static class TabLayoutOnPageChangeListener extends ViewPager2.OnPageChangeCallback {
        ...
        private final WeakReference<XTabLayoutV2> mTabLayoutRef;
        ...
        public TabLayoutOnPageChangeListener(XTabLayoutV2 xTabLayoutV2) {
            this.mTabLayoutRef = new WeakReference<>(xTabLayoutV2);
        }

        @Override
        public void onPageScrolled(int i, float f, int i2) {
            XTabLayoutV2 xTabLayoutV2 = this.mTabLayoutRef.get();
            if (xTabLayoutV2 != null) {
                int i3 = this.mScrollState;
                boolean z = false;
                xTabLayoutV2.setScrollPosition(i, f, i3 != 2 || this.mPreviousScrollState == 1, (i3 == 2 && this.mPreviousScrollState == 0) ? true : true);
            }
        }
        ...
        public void onPageSelected(int i) {
            XTabLayoutV2 xTabLayoutV2 = this.mTabLayoutRef.get();
            if (xTabLayoutV2 == null || xTabLayoutV2.getSelectedTabPosition() == i) {
                return;
            }
            int i2 = this.mScrollState;
            xTabLayoutV2.selectTab(xTabLayoutV2.getTabAt(i), i2 == 0 || (i2 == 2 && this.mPreviousScrollState == 0));
        }
    }
