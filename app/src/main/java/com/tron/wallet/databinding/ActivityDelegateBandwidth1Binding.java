...
public final class ActivityDelegateBandwidth1Binding implements ViewBinding {
    ...
    public static ActivityDelegateBandwidth1Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityDelegateBandwidth1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.activity_delegate_bandwidth_1, viewGroup, false);
        if (z) {
    ...
    public static ActivityDelegateBandwidth1Binding bind(View view) {
        int i = R.id.btn_next;
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            ...
                                                            if (viewPager2 != null) {
                                                                return new ActivityDelegateBandwidth1Binding((RelativeLayout) view, button, findChildViewById, relativeLayout, imageView, fragmentContainerView, relativeLayout2, frameLayout, xTabLayoutV2, textView, textView2, textView3, textView4, textView5, viewPager2);
                                                            }
                                                        }
                                                    }
                                                }
