...
public final class FgVotePendingBinding implements ViewBinding {
    ...
    private FgVotePendingBinding(RelativeLayout relativeLayout, Button button, Button button2, Button button3, ImageView imageView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, TextView textView, TextView textView2) {
    ...
    public static FgVotePendingBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FgVotePendingBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fg_vote_pending, viewGroup, false);
        if (z) {
    ...
    public static FgVotePendingBinding bind(View view) {
                        ...
                        if (relativeLayout2 != null) {
                            ...
                            if (relativeLayout3 != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        return new FgVotePendingBinding(relativeLayout, button, button2, button3, imageView, relativeLayout, relativeLayout2, relativeLayout3, textView, textView2);
                                    }
                                }
                            }
                        }
