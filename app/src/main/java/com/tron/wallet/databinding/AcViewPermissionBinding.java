...
public final class AcViewPermissionBinding implements ViewBinding {
    ...
    private AcViewPermissionBinding(RelativeLayout relativeLayout, Button button, TagFlowLayout tagFlowLayout, TagFlowLayout tagFlowLayout2, TagFlowLayout tagFlowLayout3, TagFlowLayout tagFlowLayout4, TagFlowLayout tagFlowLayout5, TagFlowLayout tagFlowLayout6, TagFlowLayout tagFlowLayout7, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
        ...
        this.flTrc10Permission = tagFlowLayout7;
    ...
    public static AcViewPermissionBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AcViewPermissionBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.ac_view_permission, viewGroup, false);
        if (z) {
    ...
    public static AcViewPermissionBinding bind(View view) {
        int i = R.id.bt_got_it;
        Button button = (Button) ViewBindings.findChildViewById(view, R.id.bt_got_it);
        if (button != null) {
                        ...
                        if (tagFlowLayout4 != null) {
                            ...
                            if (tagFlowLayout5 != null) {
                                ...
                                if (tagFlowLayout6 != null) {
                                    ...
                                    TagFlowLayout tagFlowLayout7 = (TagFlowLayout) ViewBindings.findChildViewById(view, R.id.fl_trc10_permission);
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            ...
                                                            if (textView6 != null) {
                                                                ...
                                                                if (textView7 != null) {
                                                                    return new AcViewPermissionBinding((RelativeLayout) view, button, tagFlowLayout, tagFlowLayout2, tagFlowLayout3, tagFlowLayout4, tagFlowLayout5, tagFlowLayout6, tagFlowLayout7, textView, textView2, textView3, textView4, textView5, textView6, textView7);
                                                                }
                                                            }
                                                        }
                                                    }
