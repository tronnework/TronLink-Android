...
public final class PopMyAssetSortBinding implements ViewBinding {
    ...
    private PopMyAssetSortBinding(RelativeLayout relativeLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, LinearLayout linearLayout, LinearLayout linearLayout2, ConstraintLayout constraintLayout, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5) {
    ...
    public static PopMyAssetSortBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static PopMyAssetSortBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.pop_my_asset_sort, viewGroup, false);
        if (z) {
    ...
    public static PopMyAssetSortBinding bind(View view) {
        int i = R.id.iv_scam_token_tips;
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            return new PopMyAssetSortBinding(relativeLayout2, imageView, imageView2, imageView3, imageView4, linearLayout, linearLayout2, constraintLayout, relativeLayout, relativeLayout2, textView, textView2, textView3, textView4, textView5);
                                                        }
                                                    }
                                                }
                                            }
