...
public final class FragmentBrowserHistoryBinding implements ViewBinding {
    ...
    private FragmentBrowserHistoryBinding(RelativeLayout relativeLayout, NestedScrollView nestedScrollView, NoNetView noNetView, PtrHTFrameLayout ptrHTFrameLayout, ImageView imageView, RecyclerView recyclerView, TextView textView) {
    ...
    public static FragmentBrowserHistoryBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentBrowserHistoryBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
    ...
    public static FragmentBrowserHistoryBinding bind(View view) {
                ...
                if (ptrHTFrameLayout != null) {
                    ...
                    if (imageView != null) {
                        ...
                        if (recyclerView != null) {
                            ...
                            if (textView != null) {
                                return new FragmentBrowserHistoryBinding((RelativeLayout) view, nestedScrollView, noNetView, ptrHTFrameLayout, imageView, recyclerView, textView);
                            }
                        }
                    }
                }
