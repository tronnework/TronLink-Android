...
public final class LayoutTabTopBinding implements ViewBinding {
    ...
    private LayoutTabTopBinding(RelativeLayout relativeLayout, ImageView imageView, LinearLayout linearLayout, MsgView msgView, TextView textView) {
    ...
    public static LayoutTabTopBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static LayoutTabTopBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
    ...
    public static LayoutTabTopBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (linearLayout != null) {
                ...
                if (msgView != null) {
                    ...
                    if (textView != null) {
                        return new LayoutTabTopBinding((RelativeLayout) view, imageView, linearLayout, msgView, textView);
                    }
                }
            }
        }
