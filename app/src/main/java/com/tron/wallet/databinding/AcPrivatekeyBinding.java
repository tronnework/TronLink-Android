...
public final class AcPrivatekeyBinding implements ViewBinding {
    ...
    private AcPrivatekeyBinding(LinearLayout linearLayout, BackupItemView backupItemView, Button button, ItemBackupTip1Binding itemBackupTip1Binding, ItemBackupTip2Binding itemBackupTip2Binding, LinearLayout linearLayout2) {
    ...
    public static AcPrivatekeyBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AcPrivatekeyBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.ac_privatekey, viewGroup, false);
        if (z) {
    ...
    public static AcPrivatekeyBinding bind(View view) {
        int i = R.id.back_pri;
                ...
                if (findChildViewById != null) {
                    ...
                    if (findChildViewById2 != null) {
                        ...
                        if (linearLayout != null) {
                            return new AcPrivatekeyBinding((LinearLayout) view, backupItemView, button, bind, bind2, linearLayout);
                        }
                    }
                }
            }
