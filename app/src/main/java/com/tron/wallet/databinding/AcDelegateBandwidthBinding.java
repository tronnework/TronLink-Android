...
public final class AcDelegateBandwidthBinding implements ViewBinding {
    ...
    private AcDelegateBandwidthBinding(RelativeLayout relativeLayout, TextView textView, DelegateResourceLockedView delegateResourceLockedView, StakeHeaderView stakeHeaderView, TabWithPercentSettingBinding tabWithPercentSettingBinding, TextView textView2, TextView textView3) {
    ...
    public static AcDelegateBandwidthBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AcDelegateBandwidthBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.ac_delegate_bandwidth, viewGroup, false);
        if (z) {
    ...
    public static AcDelegateBandwidthBinding bind(View view) {
        int i = R.id.btn_next;
                ...
                if (stakeHeaderView != null) {
                    ...
                    if (findChildViewById != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                return new AcDelegateBandwidthBinding((RelativeLayout) view, textView, delegateResourceLockedView, stakeHeaderView, bind, textView2, textView3);
                            }
                        }
                    }
                }
