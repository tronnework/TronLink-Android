...
public final class ItemSwapTokenRecordBinding implements ViewBinding {
    ...
    private ItemSwapTokenRecordBinding(RelativeLayout relativeLayout, ImageView imageView, LoadingView loadingView, LinearLayout linearLayout, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8) {
    ...
    public static ItemSwapTokenRecordBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ItemSwapTokenRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.item_swap_token_record, viewGroup, false);
        if (z) {
    ...
    public static ItemSwapTokenRecordBinding bind(View view) {
                                            ...
                                            if (textView5 != null) {
                                                ...
                                                if (textView6 != null) {
                                                    ...
                                                    if (textView7 != null) {
                                                        ...
                                                        if (textView8 != null) {
                                                            return new ItemSwapTokenRecordBinding(relativeLayout3, imageView, loadingView, linearLayout, relativeLayout, relativeLayout2, relativeLayout3, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8);
                                                        }
                                                    }
                                                }
                                            }
