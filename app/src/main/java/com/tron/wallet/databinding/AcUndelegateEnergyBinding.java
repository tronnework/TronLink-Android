...
public final class AcUndelegateEnergyBinding implements ViewBinding {
    ...
    public static AcUndelegateEnergyBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AcUndelegateEnergyBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.ac_undelegate_energy, viewGroup, false);
        if (z) {
    ...
    public static AcUndelegateEnergyBinding bind(View view) {
                                        ...
                                        if (textView4 != null) {
                                            ...
                                            if (textView5 != null) {
                                                ...
                                                if (textView6 != null) {
                                                    ...
                                                    if (textView7 != null) {
                                                        return new AcUndelegateEnergyBinding((RelativeLayout) view, textView, textView2, textView3, imageView, imageView2, relativeLayout, stakeHeaderView, bind, textView4, textView5, textView6, textView7);
                                                    }
                                                }
                                            }
                                        }
