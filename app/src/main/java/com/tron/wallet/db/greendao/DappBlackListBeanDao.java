...
public class DappBlackListBeanDao extends AbstractDao<DappBlackBean, Long> {
    public static final String TABLENAME = "DAPP_BLACK_LIST_BEAN";
    ...
    public DappBlackListBeanDao(DaoConfig daoConfig) {
        super(daoConfig);
    }

    public DappBlackListBeanDao(DaoConfig daoConfig, DaoSession daoSession) {
        super(daoConfig, daoSession);
    }

    public static void createTable(Database database, boolean z) {
        String str = z ? "IF NOT EXISTS " : "";
        database.execSQL("CREATE TABLE " + str + "\"DAPP_BLACK_LIST_BEAN\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"NAME\" TEXT);");
    }

    public static void dropTable(Database database, boolean z) {
        StringBuilder sb = new StringBuilder("DROP TABLE ");
        sb.append(z ? "IF EXISTS " : "");
        sb.append("\"DAPP_BLACK_LIST_BEAN\"");
