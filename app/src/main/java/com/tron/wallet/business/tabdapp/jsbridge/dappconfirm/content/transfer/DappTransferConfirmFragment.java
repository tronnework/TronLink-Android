...
import com.tron.wallet.business.tabdapp.jsbridge.dappconfirm.content.transfer.DappTransferConfirmContract;
...
public class DappTransferConfirmFragment extends BaseConfirmFragment<DappTransferConfirmPresenter, DappTransferConfirmModel> implements DappTransferConfirmContract.View, XTabLayout.OnTabSelectedListener {
    private FgDappConfirmSystemContractBinding binding;
    String contractTypeString;
    DappTransferTransactionDetailFragment detailFragment;
    ...
    public static DappTransferConfirmFragment getInstance(BaseParam baseParam, BaseParam baseParam2) {
        DappTransferConfirmFragment dappTransferConfirmFragment = new DappTransferConfirmFragment();
        ...
        dappTransferConfirmFragment.setArguments(bundle);
        return dappTransferConfirmFragment;
    }
    ...
    public void processData() {
        ...
        this.detailFragment = DappTransferTransactionDetailFragment.getInstance(this.detailParam);
    ...
    private void bindDataToUI() {
        ...
        String str2 = this.contractTypeString;
        str2.hashCode();
        char c = 65535;
        ...
        switch (c) {
            ...
            case 2:
                ...
                if (tokenActionType == 0) {
                    ...
                    this.ivIcon.setLayoutParams(layoutParams);
                    if (TriggerUtils.isTransferFrom(this.detailParam.getTriggerSmartContract())) {
                        str = this.detailParam.getTriggerData().getParameterMap().get("2");
                    } else {
                    ...
                    if (tokenBean2 != null) {
                        ...
                        this.detailParam.addInfoTitle(R.string.asset_transfer, str);
                        break;
                    }
    ...
    public void onTabSelected(XTabLayout.Tab tab) {
        ...
        if (position == 0) {
            DappTransferTransactionDetailFragment dappTransferTransactionDetailFragment = this.detailFragment;
            if (dappTransferTransactionDetailFragment != null) {
                beginTransaction.show(dappTransferTransactionDetailFragment).hide(this.metadataFragment);
                beginTransaction.disallowAddToBackStack();
