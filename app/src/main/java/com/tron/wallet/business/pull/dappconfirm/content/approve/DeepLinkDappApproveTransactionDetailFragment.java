...
public class DeepLinkDappApproveTransactionDetailFragment extends BaseFragment<DeepLinkDappApproveTransactionDetailPresenter, EmptyModel> implements DeepLinkDappApproveTransactionDetailContract.View, BaseConfirmFragment.AccountCallback {
    ...
    public static DeepLinkDappApproveTransactionDetailFragment getInstance(BaseParam baseParam) {
        DeepLinkDappApproveTransactionDetailFragment deepLinkDappApproveTransactionDetailFragment = new DeepLinkDappApproveTransactionDetailFragment();
        Bundle bundle = new Bundle();
        bundle.putParcelable(ArgumentKeys.KEY_PARAM, baseParam);
        deepLinkDappApproveTransactionDetailFragment.setArguments(bundle);
        return deepLinkDappApproveTransactionDetailFragment;
    }
    ...
    protected void processData() {
        ...
        if (parcelable instanceof DappDetailParam) {
            ...
            ((DeepLinkDappConfirmActivity) getActivity()).getConfirmBtn().onBind(this.param, false, "");
    ...
    private void setChildrenVisibility() {
        ...
        if (tokenActionType == 1) {
            ...
            if (isUnlimited(str, this.param.getTokenBean())) {
            ...
            this.tvContractAddress.setText(this.param.getContractAddress());
            final String str2 = this.param.getTriggerData().getParameterMap().get("1");
            ...
            runOnThreeThread(new OnBackground() {
                ...
                public final void doOnBackground() {
                    lambda$setChildrenVisibility$0(str2);
                }
            });
        }
    }
        ...
        NoDoubleClickListener2 noDoubleClickListener2 = new NoDoubleClickListener2() {
            ...
            protected void onNoDoubleClick(View view) {
                ...
                if (id == R.id.rl_contract_address) {
                    ...
                    DeepLinkDappApproveTransactionDetailFragment deepLinkDappApproveTransactionDetailFragment = DeepLinkDappApproveTransactionDetailFragment.this;
                    CommonWebActivityV3.start((Context) activity, deepLinkDappApproveTransactionDetailFragment.getTrc10Url(deepLinkDappApproveTransactionDetailFragment.param.getAssetName()), mContext.getResources().getString(R.string.tronscan), -2, true);
                    try {
                        if (!Protocol.Transaction.parseFrom(param.getTransactionBean().getBytes().get(0)).getRawData().getContract(0).getType().equals(Protocol.Transaction.Contract.ContractType.TriggerSmartContract)) {
                            i = 1;
                        }
