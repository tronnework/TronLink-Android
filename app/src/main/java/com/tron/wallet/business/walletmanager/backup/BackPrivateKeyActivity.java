...
import com.tron.wallet.databinding.AcPrivatekeyBinding;
...
public class BackPrivateKeyActivity extends BaseActivity<BackPresenter, EmptyModel> implements BackupContract.View, BackupItemView.IOnClickListener {
    private AcPrivatekeyBinding binding;
    Button btnDone;
    ...
    protected void setLayout() {
        AcPrivatekeyBinding inflate = AcPrivatekeyBinding.inflate(getLayoutInflater());
    ...
    private void showDialog() {
        CommonNoticeDialog cancleBt = new CommonNoticeDialog(this.mContext).setTitle(R.string.risk_warning).setContent(R.string.warning_back_privatekey).setBtListener(R.string.copy_continue, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                UIUtils.copy(privateKey, true);
