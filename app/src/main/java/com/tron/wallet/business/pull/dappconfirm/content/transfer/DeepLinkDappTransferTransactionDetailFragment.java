...
public class DeepLinkDappTransferTransactionDetailFragment extends BaseFragment<DeepLinkDappTransferTransactionDetailPresenter, EmptyModel> implements DeepLinkDappTransferTransactionDetailContract.View, BaseConfirmFragment.AccountCallback {
    View addressScamTag;
    ...
    public static DeepLinkDappTransferTransactionDetailFragment getInstance(BaseParam baseParam) {
        DeepLinkDappTransferTransactionDetailFragment deepLinkDappTransferTransactionDetailFragment = new DeepLinkDappTransferTransactionDetailFragment();
        Bundle bundle = new Bundle();
        bundle.putParcelable(ArgumentKeys.KEY_PARAM, baseParam);
        deepLinkDappTransferTransactionDetailFragment.setArguments(bundle);
        return deepLinkDappTransferTransactionDetailFragment;
    }
    ...
    protected void processData() {
        ...
        if (parcelable instanceof DappDetailParam) {
            ...
            DappConfirmButton confirmBtn = ((DeepLinkDappConfirmActivity) getActivity()).getConfirmBtn();
            DappDetailParam dappDetailParam = this.param;
            confirmBtn.onBind(dappDetailParam, true, dappDetailParam.getToAddress());
    ...
    public void lambda$processData$1() {
        new ArrayList().add(((DappDetailParam) this.baseParam).getToAddress());
        AddressManager.checkSingleAddressScam(((DappDetailParam) this.baseParam).getToAddress()).subscribe(new Consumer() {
            @Override
    ...
    public void lambda$processData$0(RiskAccountOutput riskAccountOutput) throws Exception {
        ...
        ((DeepLinkDappConfirmActivity) getActivity()).getConfirmBtn().setFinishGetScam(isRisk);
        if (isRisk) {
            showScamView();
        }
    }
    ...
    private void bindDataToUI() {
        ...
        if (dappDetailParam.getContractType() == 1 || this.param.getContractType() == 2) {
            ((DeepLinkDappTransferTransactionDetailPresenter) this.mPresenter).getAccount(this.param.getToAddress());
        }
        ...
        NoDoubleClickListener2 noDoubleClickListener2 = new NoDoubleClickListener2() {
            ...
            protected void onNoDoubleClick(View view) {
                ...
                if (id == R.id.rl_contract_address) {
                    ...
                    DeepLinkDappTransferTransactionDetailFragment deepLinkDappTransferTransactionDetailFragment = DeepLinkDappTransferTransactionDetailFragment.this;
                    CommonWebActivityV3.start((Context) activity, deepLinkDappTransferTransactionDetailFragment.getTrc10Url(deepLinkDappTransferTransactionDetailFragment.param.getAssetName()), mContext.getResources().getString(R.string.tronscan), -2, true);
                    try {
                        if (!Protocol.Transaction.parseFrom(param.getTransactionBean().getBytes().get(0)).getRawData().getContract(0).getType().equals(Protocol.Transaction.Contract.ContractType.TriggerSmartContract)) {
                            i = 1;
                        }
