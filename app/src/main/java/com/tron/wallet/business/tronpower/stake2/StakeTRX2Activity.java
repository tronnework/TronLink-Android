package com.tron.wallet.business.tronpower.stake2;
...
import com.tron.wallet.business.tronpower.stake.StakeTRXModel;
import com.tron.wallet.business.tronpower.stake.StakeTRXPresenter;
...
import com.tron.wallet.databinding.AcStakeTrx2Binding;
...
public class StakeTRX2Activity extends BaseActivity<StakeTRXPresenter, StakeTRXModel> implements StakeTRXContract.View {
    ...
    public static String IS_ENERGY = "isEnergy";
    ...
    private AcStakeTrx2Binding binding;
    TextView btGo;
    Button btnNextStep;
    View divider;
    EditText edInputRes;
    ...
    public static void start(Context context, String str, String str2, Protocol.Account account, DataStatHelper.StatAction statAction) {
        Intent intent = new Intent(context, StakeTRX2Activity.class);
    ...
    public static void start(final Context context, final Protocol.Account account) {
        AccountUtils.getInstance().checkAccountIsActivatedFromLocal(context, new CheckAccountActivatedCallback() {
            ...
            public void isActivated() {
                Intent intent = new Intent(context, StakeTRX2Activity.class);
                intent.putExtra(StakeTRX2Activity.ACCOUNT, account);
                context.startActivity(intent);
            }
        }, new CheckAccountNotActivatedCallback() {
            @Override
            public void notActivated() {
                StakeTRX2Activity.showPop(context);
            }
        });
    }

    public static void start(final Context context, final Protocol.Account account, final DataStatHelper.StatAction statAction, final boolean z) {
        AccountUtils.getInstance().checkAccountIsActivatedFromLocal(context, new CheckAccountActivatedCallback() {
            @Override
            public void isActivated() {
                Intent intent = new Intent(context, StakeTRX2Activity.class);
                intent.putExtra(StakeTRX2Activity.ACCOUNT, account);
                intent.putExtra(StakeTRX2Activity.IS_ENERGY, z);
                intent.putExtra(TronConfig.StatAction_Key, statAction);
                context.startActivity(intent);
            }
        }, new CheckAccountNotActivatedCallback() {
            ...
            public final void doInUIThread() {
                ConfirmCustomPopupView.getBuilder(r0).setTitle(r0.getResources().getString(R.string.stake_account_unactive)).setTitleBold(true).setTitleSize(16).setConfirmText(r0.getResources().getString(R.string.confirm)).setConfirmListener(new View.OnClickListener() {
                    ...
                    public final void onClick(View view) {
                        StakeTRX2Activity.lambda$showPop$0(view);
                    }
                    ...
                    @Override
                    public final void onClick(View view) {
                        StakeTRX2Activity.lambda$showPop$1(r1, view);
                    }
                }).build().show();
            }
        });
    ...
    public static void startWithCheckOwnerPermission(final Context context, final boolean z, final Protocol.Account account, final DataStatHelper.StatAction statAction, String str) {
        OwnerPermissionCheckUtils.checkStakeWithPopup(context, account, R.string.stake_account_unactive, R.string.lack_of_stake_permission, new Consumer() {
            ...
            public final void accept(Object obj) {
                Void r5 = (Void) obj;
                StakeTRX2Activity.start(context, account, statAction, z);
            }
    ...
    protected void setLayout() {
        ...
        AcStakeTrx2Binding inflate = AcStakeTrx2Binding.inflate(getLayoutInflater());
        ...
        getHeaderHolder().ivCommonTitle2.setBackground(getResources().getDrawable(R.mipmap.ic_question_tip));
        if (this.isMultisign) {
            getHeaderHolder().ivCommonTitle2.setVisibility(View.GONE);
        } else {
            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.PV_BASE_1_2_TAG);
        }
        ...
        getHeaderHolder().ivCommonTitle3.setVisibility(View.VISIBLE);
        getHeaderHolder().ivCommonTitle3.setBackground(getResources().getDrawable(R.mipmap.icon_stake20_fat));
        ...
        getHeaderHolder().ivCommonTitle2.setOnClickListener(new NoDoubleClickListener() {
            ...
            protected void onNoDoubleClick(View view) {
                if (isMultisign) {
                    AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_TITLE_2_3_QUESTION_MARK);
                } else {
                    AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_TITLE_QUESTION_MARK);
                }
                AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_HEADEDU_CLICK);
                if (enableStateV2()) {
                    Context context = mContext;
                    String resString = StringTronUtil.getResString(R.string.instruction_stake_v2);
                    String resString2 = StringTronUtil.getResString(R.string.instruction_stake_v2_1);
                    String string = mContext.getString(R.string.instruction_stake_v2_2, numberFormat.format(TronConfig.bandwidthForFree));
                    String resString3 = StringTronUtil.getResString(R.string.instruction_stake_v2_3);
                    Context context2 = mContext;
                    TrxInstructionsActivity.start(context, resString, resString2, string, resString3, context2.getString(R.string.instruction_stake_v2_4, TronSetting.stakeExpireDay + ""), StringTronUtil.getResString(R.string.instruction_stake_v2_5), "", true, true);
                } else {
    ...
    public void mappingId() {
        ...
        this.tvStakeExpireDayTips = this.binding.tvStakeExpireDayTips;
        this.divider = this.binding.divider;
        this.llBtnGo = this.binding.llBtGo;
        this.btGo = this.binding.btGo;
    }

    public boolean enableStateV2() {
        return TronSetting.stakeV2;
    }

    @Override
    protected void processData() {
        if (getIntent() != null && !StringTronUtil.isEmpty(getIntent().getStringExtra("address"))) {
            ...
            this.mSelectAddress = selectedWallet.getAddress();
        ...
        DesugarArrays.stream(new View[]{this.binding.amountPercent25, this.binding.amountPercent50, this.binding.amountPercent75, this.binding.amountPercent100, this.binding.btnNextStep, this.binding.tvStakeEnergy, this.binding.tvStakeBandwidth, this.binding.ivStakeEdit, this.binding.rlTips}).forEach(new Consumer() {
            @Override
            public final void accept(Object obj) {
                lambda$processData$5((View) obj);
            }
        ...
        this.etAmount.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == 1) {
                    if (isMultisign) {
                        AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_2_3_INPUT);
                        return false;
                    }
                    AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_INPUT);
                    return false;
                }
                return false;
            }
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (!StringTronUtil.isEmpty(obj)) {
                    if (obj.startsWith("0") && obj.length() > 1) {
                        ...
                        edInputRes.setSelection(edInputRes.getText().length() - 1);
                        return;
        ...
        if (this.isFreezeBandwidth) {
            AnalyticsHelper.ResourceDetailPage.logMultiEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_PAGESHOW_BANDWIDTH, this.isMultisign);
        } else {
            AnalyticsHelper.ResourceDetailPage.logMultiEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_PAGESHOW_ENENGY, this.isMultisign);
        }
        if (this.isMultisign) {
            AnalyticsHelper.AssetPage.logEvent("MultisigStakingV2_2_3");
        }
        if (getIntent() != null) {
            switchEnergyBandwidth(getIntent().getBooleanExtra(IS_ENERGY, true));
        }
        this.tvStakeExpireDayTips.setText(String.format(getString(R.string.stake2_bottom_tips2), Integer.valueOf(TronSetting.stakeExpireDay)));
    }

    public void lambda$processData$5(View view) {
        view.setOnClickListener(getOnClickListener());
    }

    public void lambda$processData$6(String str) {
    ...
    private void showGoToJustLend() {
        if (this.isMultisign || this.isFreezeBandwidth) {
    ...
    public ObservableSource lambda$ensureAccount$8(final Protocol.Account account, Observable observable) {
        return ((StakeTRXPresenter) this.mPresenter).isNullAccount(account) ? observable : Observable.create(new ObservableOnSubscribe() {
            ...
            public final void subscribe(ObservableEmitter observableEmitter) {
                StakeTRX2Activity.lambda$ensureAccount$7(Protocol.Account.this, observableEmitter);
            }
        });
    }
    ...
    private ICallback<Protocol.Account> getEnsureAccountCallback() {
        return new ICallback<Protocol.Account>() {
            ...
            public void onResponse(String str, Protocol.Account account) {
                ...
                StakeTRX2Activity stakeTRX2Activity = StakeTRX2Activity.this;
                stakeTRX2Activity.hasOwnerPermission = ((StakeTRXPresenter) stakeTRX2Activity.mPresenter).hasOwnerPermission(mSelectAddress, mAccount);
                if (!isMultisign && AccountUtils.checkAccountIsNotActivated(mAccount)) {
                    showMultiSignDialog();
                } else if (!isMultisign && !hasOwnerPermission) {
                    showMultiSignDialog();
                }
                StakeTRX2Activity stakeTRX2Activity2 = StakeTRX2Activity.this;
                stakeTRX2Activity2.updateUI(stakeTRX2Activity2.mAccount, mAccountResMessage);
            }

            @Override
            public void onFailure(String str, String str2) {
                StakeTRX2Activity stakeTRX2Activity = StakeTRX2Activity.this;
                stakeTRX2Activity.toast(stakeTRX2Activity.getString(R.string.time_out));
            }
    ...
    private void enterMultiSign() {
        try {
            MultiSelectAddressActivity.start(this, MultiSourcePageEnum.StakeV2);
            exit();
        } catch (Throwable th) {
            LogUtils.e(th);
        }
            ...
            protected void onNoDoubleClick(View view) {
                switch (view.getId()) {
                    case R.id.amount_percent_100:
                        if (isFreezeBandwidth) {
                            AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_BANDWIDTH_CLICK_25);
                        } else {
                            AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_ENERGY_CLICK_25);
                        }
                        resetBottomInputView();
                        StakeTRX2Activity stakeTRX2Activity = StakeTRX2Activity.this;
                        stakeTRX2Activity.setTvPercentBg(stakeTRX2Activity.tvPercent100);
                        percentIndex = 4;
                        setEtAmount(1.0f);
                        return;
                    case R.id.amount_percent_25:
                        ...
                        resetBottomInputView();
                        StakeTRX2Activity stakeTRX2Activity2 = StakeTRX2Activity.this;
                        stakeTRX2Activity2.setTvPercentBg(stakeTRX2Activity2.tvPercent25);
                        percentIndex = 1;
                        setEtAmount(0.25f);
                        return;
                    case R.id.amount_percent_50:
                        ...
                        resetBottomInputView();
                        StakeTRX2Activity stakeTRX2Activity3 = StakeTRX2Activity.this;
                        stakeTRX2Activity3.setTvPercentBg(stakeTRX2Activity3.tvPercent50);
                        percentIndex = 2;
                        setEtAmount(0.5f);
                        return;
                    case R.id.amount_percent_75:
                        ...
                        resetBottomInputView();
                        StakeTRX2Activity stakeTRX2Activity4 = StakeTRX2Activity.this;
                        stakeTRX2Activity4.setTvPercentBg(stakeTRX2Activity4.tvPercent75);
                        percentIndex = 3;
                        setEtAmount(0.75f);
                        return;
                    case R.id.btn_next_step:
                        if (isMultisign) {
                            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_2_3_NEXT);
                        } else {
                            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_NEXT_BTN);
                        }
                        if (isFreezeBandwidth) {
                            AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_BANDWIDTH_CLICK_STAKE);
                        } else {
                            AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_ENERGY_CLICK_STAKE);
                        }
                        ((StakeTRXPresenter) mPresenter).stake2();
                        return;
                    case R.id.iv_stake_edit:
                        AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_RESOURCE_EDIT);
                        ...
                        return;
                    case R.id.rl_tips:
                        KeyboardUtil.closeKeybord(StakeTRX2Activity.this);
                        AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_ESTIMATED_TO_GET);
                    ...
                    case R.id.tv_stake_bandwidth:
                        AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_BANDWIDTH_CLICK_BANDWIDTH_MODIFICATION);
                        if (isMultisign) {
                            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_BANDWIDTH);
                        } else {
                            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_BANDWIDTH_TAG);
                        }
                        ...
                        StakeTRX2Activity stakeTRX2Activity5 = StakeTRX2Activity.this;
                        stakeTRX2Activity5.setTvPercentBg(stakeTRX2Activity5.tvCurrentPercentBg);
                        return;
                    case R.id.tv_stake_energy:
                        AnalyticsHelper.logEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_ENERGY_CLICK_ENERGY_MODIFICATION);
                        if (isMultisign) {
                            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_ENERGY);
                        } else {
                            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_ENERGY_TAG);
                        }
                        ...
                        StakeTRX2Activity stakeTRX2Activity6 = StakeTRX2Activity.this;
                        stakeTRX2Activity6.setTvPercentBg(stakeTRX2Activity6.tvCurrentPercentBg);
                        return;
                    default:
                        return;
                }
    ...
    public void switchEnergyBandwidth(boolean z) {
        ...
        if (z2) {
            ...
            this.divider.setBackground(getDrawable(R.color.gray_e2f4f1));
        } else {
            ...
            this.divider.setBackground(getDrawable(R.color.gray_f9edde));
        }
        showGoToJustLend();
        if (this.isFreezeBandwidth) {
            AnalyticsHelper.ResourceDetailPage.logMultiEvent(AnalyticsHelper.ResourceDetailPage.STAKE2ACTION_PAGESHOW_BANDWIDTH, this.isMultisign);
    ...
    public void setEtAmount(float f) {
        double d;
        if (this.isMultisign) {
            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_PERCENT);
        } else {
            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_PERCENT_BUTTON);
        }
    ...
    public BigDecimal expectGetBandWidth(BigDecimal bigDecimal) {
        if (this.mAccountResMessage != null && compareWithZero(bigDecimal, BigDecimal.ZERO) == 1) {
            ...
            if (bigDecimal2.compareTo(BigDecimal.ZERO) != 0) {
                return bigDecimal.multiply(bigDecimal3).divide(bigDecimal2.subtract(bigDecimal), 0, 1);
            }
    ...
    public void onLeftButtonClick() {
        ...
        if (this.isMultisign) {
            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_2_3_BACK);
        } else {
            AnalyticsHelper.AssetPage.logEvent(AnalyticsHelper.Staking2.CLICK_BACK);
        }
        finish();
    }
