...
public class StakeV2PopModel implements StakeV2PopContract.Model {
    ...
    public BaseConfirmTransParamBuilder buildTransactionParam(Protocol.Account account, final String str, boolean z, GrpcAPI.AccountResourceMessage accountResourceMessage, java.util.Collection<StakeDetailResourceBean> collection) {
        ...
        Collection.-EL.stream(collection).forEach(new Consumer() {
            @Override
            public final void accept(Object obj) {
                lambda$buildTransactionParam$4(str, arrayList, hashMap, jArr, typeArr, (StakeDetailResourceBean) obj);
            }
    ...
    public void lambda$buildTransactionParam$4(String str, List list, HashMap hashMap, long[] jArr, FreezeUnFreezeParam.TYPE[] typeArr, StakeDetailResourceBean stakeDetailResourceBean) {
    ...
    public static int lambda$build$6(StakeDetailResourceBean stakeDetailResourceBean, StakeDetailResourceBean stakeDetailResourceBean2) {
        int i = ((stakeDetailResourceBean.getExpiredTime() - stakeDetailResourceBean2.getExpiredTime()) > 0L ? 1 : ((stakeDetailResourceBean.getExpiredTime() - stakeDetailResourceBean2.getExpiredTime()) == 0L ? 0 : -1));
        if (i < 0) {
            return -1;
        }
        return i == 0 ? 0 : 1;
