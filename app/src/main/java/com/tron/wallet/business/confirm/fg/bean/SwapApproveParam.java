...
public class SwapApproveParam extends BaseParam implements Parcelable {
    ...
    public static final Parcelable.Creator<BaseParam> CREATOR = new Parcelable.Creator<BaseParam>() {
        ...
        public BaseParam createFromParcel(Parcel parcel) {
            return new SwapApproveParam(parcel);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SwapApproveParam) {
            SwapApproveParam swapApproveParam = (SwapApproveParam) obj;
            if (swapApproveParam.canEqual(this) && getContractType() == swapApproveParam.getContractType() && getTokenActionType() == swapApproveParam.getTokenActionType() && getTitleId() == swapApproveParam.getTitleId() && isAccount() == swapApproveParam.isAccount() && isDetail() == swapApproveParam.isDetail() && isApprove() == swapApproveParam.isApprove() && isTransfer() == swapApproveParam.isTransfer() && getIsActive() == swapApproveParam.getIsActive()) {
                String amount = getAmount();
                String amount2 = swapApproveParam.getAmount();
                if (amount != null ? amount.equals(amount2) : amount2 == null) {
                    String ownerAddress = getOwnerAddress();
                    String ownerAddress2 = swapApproveParam.getOwnerAddress();
                    if (ownerAddress != null ? ownerAddress.equals(ownerAddress2) : ownerAddress2 == null) {
                        String toAddress = getToAddress();
                        String toAddress2 = swapApproveParam.getToAddress();
                        if (toAddress != null ? toAddress.equals(toAddress2) : toAddress2 == null) {
                            TokenBean tokenBean = getTokenBean();
                            TokenBean tokenBean2 = swapApproveParam.getTokenBean();
                            if (tokenBean != null ? tokenBean.equals(tokenBean2) : tokenBean2 == null) {
                                String contractTypeString = getContractTypeString();
                                String contractTypeString2 = swapApproveParam.getContractTypeString();
                                if (contractTypeString != null ? contractTypeString.equals(contractTypeString2) : contractTypeString2 == null) {
                                    String contractAddress = getContractAddress();
                                    String contractAddress2 = swapApproveParam.getContractAddress();
                                    if (contractAddress != null ? contractAddress.equals(contractAddress2) : contractAddress2 == null) {
                                        String note = getNote();
                                        String note2 = swapApproveParam.getNote();
                                        if (note != null ? note.equals(note2) : note2 == null) {
                                            String assetName = getAssetName();
                                            String assetName2 = swapApproveParam.getAssetName();
                                            if (assetName != null ? assetName.equals(assetName2) : assetName2 == null) {
                                                TriggerData triggerData = getTriggerData();
                                                TriggerData triggerData2 = swapApproveParam.getTriggerData();
                                                if (triggerData != null ? triggerData.equals(triggerData2) : triggerData2 == null) {
                                                    ...
                                                    DappProjectInfoBean dappProjectInfoBean2 = swapApproveParam.getDappProjectInfoBean();
                                                    if (dappProjectInfoBean != null ? dappProjectInfoBean.equals(dappProjectInfoBean2) : dappProjectInfoBean2 == null) {
                                                        ...
                                                        SmartContractOuterClass.TriggerSmartContract triggerSmartContract2 = swapApproveParam.getTriggerSmartContract();
    ...
    public int hashCode() {
        int contractType = ((((((((((((((getContractType() + 59) * 59) + getTokenActionType()) * 59) + getTitleId()) * 59) + (isAccount() ? 79 : 97)) * 59) + (isDetail() ? 79 : 97)) * 59) + (isApprove() ? 79 : 97)) * 59) + (isTransfer() ? 79 : 97)) * 59) + getIsActive();
        String amount = getAmount();
    ...
    public SwapApproveParam() {
    }

    protected SwapApproveParam(Parcel parcel) {
        super(parcel);
        boolean readBoolean;
