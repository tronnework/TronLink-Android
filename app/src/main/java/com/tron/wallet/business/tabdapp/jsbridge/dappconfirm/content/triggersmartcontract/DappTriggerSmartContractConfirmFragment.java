...
public class DappTriggerSmartContractConfirmFragment extends BaseConfirmFragment<DappTriggerSmartContractConfirmPresenter, DappTriggerSmartContractConfirmModel> implements DappTriggerSmartContractConfirmContract.View, XTabLayout.OnTabSelectedListener {
    RelativeLayout approveLayout;
    private FgDappConfirmSystemContractBinding binding;
    String contractTypeString;
    DappTriggerSmartContractDetailFragment detailFragment;
    ...
    public static DappTriggerSmartContractConfirmFragment getInstance(BaseParam baseParam, BaseParam baseParam2) {
        DappTriggerSmartContractConfirmFragment dappTriggerSmartContractConfirmFragment = new DappTriggerSmartContractConfirmFragment();
        ...
        dappTriggerSmartContractConfirmFragment.setArguments(bundle);
        return dappTriggerSmartContractConfirmFragment;
    }
    ...
    public void processData() {
        ...
        this.detailFragment = DappTriggerSmartContractDetailFragment.getInstance(this.detailParam);
    ...
    public void onTabSelected(XTabLayout.Tab tab) {
        ...
        if (position == 0) {
            DappTriggerSmartContractDetailFragment dappTriggerSmartContractDetailFragment = this.detailFragment;
            if (dappTriggerSmartContractDetailFragment != null) {
                beginTransaction.show(dappTriggerSmartContractDetailFragment).hide(this.metadataFragment);
                beginTransaction.disallowAddToBackStack();
