...
public class DelegatePendingFragment extends BaseFragment<ConfirmPendingPresenter, ConfirmPendingModel> implements ConfirmPendingContract.View {
    ...
    public static DelegatePendingFragment getInstance(State state, BaseParam baseParam, byte[] bArr, int i) {
        DelegatePendingFragment delegatePendingFragment = new DelegatePendingFragment();
        ...
        delegatePendingFragment.setArguments(bundle);
        return delegatePendingFragment;
    }
    ...
    public void onSuccess(TransactionInfoBean transactionInfoBean, final BaseParam baseParam) {
        ...
        this.tvResult.setText(R.string.resource_delegate_success);
    ...
    public void onFail(final BaseParam baseParam, int i, String str) {
        ...
        this.tvResult.setText(R.string.resource_delegate_fail);
