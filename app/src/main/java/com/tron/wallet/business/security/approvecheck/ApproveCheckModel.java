...
public class ApproveCheckModel implements ApproveCheckContract.Model {
    @Override
    public Observable<ApproveListDatabeanOutput> requestApproveList(String str, String str2) {
        return ((HttpAPI) IRequest.getAPI(HttpAPI.class)).requestApproveList(str, str2).compose(RxSchedulers.io_main());
    }

    public class fun1 implements Callable<HashMap<String, NameAddressExtraBean>> {
        fun1() {
        }
        ...
        public HashMap<String, NameAddressExtraBean> call() throws Exception {
            ...
            Collection.-EL.stream(WalletUtils.getAllWallets()).filter(new Predicate() {
                ...
                public final boolean test(Object obj) {
                    return ApproveCheckModel.1.lambda$call$1((Wallet) obj);
                }
            }).sorted(new Comparator() {
                @Override
                public final int compare(Object obj, Object obj2) {
                    return ApproveCheckModel.1.lambda$call$2((Wallet) obj, (Wallet) obj2);
                }
